...
public class BattleshipController {
    ...
    int count = 0;
    int attackerId;
    boolean attackerAlreadySet = false;
    ...
    public void setAttackerId(int id) {
        if(attackerAlreadySet == false) {
       this.attackerId = id; 
       attackerAlreadySet = true;
        }
    }
    ...
    public String getOpponentName(int id) throws RemoteException {
        return model.getOpponentName(id);
    }
    ...
    public String getWinnerName() {
        return model.getWinnerName(this.attackerId);
    }

    public void setPlayerName(int id, String name){
        model.setPlayerName(id, name);
    }
}
