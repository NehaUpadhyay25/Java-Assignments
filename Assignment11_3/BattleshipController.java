...
public class BattleshipController extends Thread{
    ...
    public BattleshipController(BattleshipModel model, DatagramSocket sock) {
        this.model = model;
        model.initialize();
        view = new BattleshipView(this, model, sock);
